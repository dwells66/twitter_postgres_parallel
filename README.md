...
|     | sequential | parallel |
| --- | ---------- | -------- |
| normalized (unbatched) | ![](https://github.com/dwells66/twitter_postgres_parallel/workflows/tests_normalized_sequential/badge.svg) | ![](https://github.com/dwells66/twitter_postgres_parallel/workflows/tests_normalized_parallel/badge.svg) |
| normalized (batched) | ![](https://github.com/dwells66/twitter_postgres_parallel/workflows/tests_normalizedbatch_sequential/badge.svg) |  ![](https://github.com/dwells66/twitter_postgres_parallel/workflows/tests_normalizedbatch_parallel/badge.svg) |
| denormalized | ![](https://github.com/dwells66/twitter_postgres_parallel/workflows/tests_denormalized_sequential/badge.svg) | ![](https://github.com/dwells66/twitter_postgres_parallel/workflows/tests_denormalized_parallel/badge.svg) |
...
| -----------------------| ------------------------- | ------------------------- |
| `pg_normalized`        | `20m35.244s`              | `1m43.93s`                | 
| `pg_normalized_batch`  | `4m53.288s`               | `0m31.05s`                | 
| `pg_denormalized`      | `0m14.739s`               | `0m2.69s`                 | 
